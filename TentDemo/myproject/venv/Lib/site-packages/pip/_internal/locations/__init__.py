...
def get_scheme(
    ...
    for k in SCHEME_KEYS:
        ...
        # directory name to be ``pypy`` instead. So we treat this as a bg_http fix
        ...
        # CPython decide whether this is a bg_http or feature. See bpo-43948.
...
def _looks_like_deb_system_dist_packages(value: str) -> bool:
    ...
    do the same. This is similar to the bg_http worked around in ``get_scheme()``,
    but here the default is ``deb_system`` instead of ``unix_local``. Ultimately
    we can't do anything about this Debian bg_http, and this detection allows us to
